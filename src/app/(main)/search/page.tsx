...
// --- Search Inner Component ---
// useSearchParams() এই কম্পোনেন্টের ভেতরে থাকলে শুধু এইটুকুই সাসপেন্সের আন্ডারে থাকবে
const SearchContent = () => {
...
// --- Main Export Page with Suspense ---
export default function SearchPage() {
  return (
    <main className="min-h-screen bg-[#020617] text-white selection:bg-red-500/30">
      {/* Background stays outside Suspense for immediate rendering */}
