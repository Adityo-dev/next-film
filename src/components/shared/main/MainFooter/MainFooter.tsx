...
const MainFooter = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#020617] pt-24 pb-10">
      ...
      <div className="absolute top-0 left-0 h-px w-full bg-linear-to-r from-transparent via-blue-600/30 to-transparent"></div>
      <div className="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-blue-600/5 blur-[120px]"></div>
      <div className="absolute -right-24 -bottom-24 h-96 w-96 rounded-full bg-blue-600/5 blur-[120px]"></div>
            ...
            <div className="col-span-2 space-y-6 sm:col-span-1">
              ...
              <div className="space-y-5 text-sm text-gray-400">
                <div className="group flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/5 bg-white/5 text-blue-500 transition-all group-hover:bg-blue-600 group-hover:text-white">
                    <Mail size={18} />
                  </div>
          ...
          <div className="mt-6 flex items-center gap-4 md:mt-0">
            {[Facebook, Github, Instagram, Youtube].map((Icon, index) => (
              <Link
                key={index}
                href="#"
                className="group relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-white/5 text-gray-400 transition-all hover:border-blue-600/50"
              >
                <div className="absolute inset-0 translate-y-full bg-blue-600 transition-transform duration-300 group-hover:translate-y-0"></div>
                <Icon
                  size={20}
